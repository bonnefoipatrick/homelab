resource "proxmox_virtual_environment_file" "debian_cloud_image" {
  ...
  source_file {
    path      = "https://cdimage.debian.org/images/cloud/bookworm/20231013-1532/debian-12-genericcloud-amd64-20231013-1532.qcow2"
    file_name = "debian-12-genericcloud-amd64-20231013-1532.img"
